...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("buynowcoin-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "buynowcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("buynowcoin-dnsseed");
...
unsigned int pnSeed[] =
{
    0xa326ea01, 0xb2991c73, 0x26bc02ad, 0x7ab743ad, 0x0ab3a7bc,
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("buynowcoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("buynowcoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("buynowcoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. buynowcoin is probably already running."), addrBind.ToString().c_str());
        else
